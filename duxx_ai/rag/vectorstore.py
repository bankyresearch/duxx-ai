...
HippoVectorStore = _vector_store_stub("Hippo", "hippodb", "Hippo vector database")
InfiniFlowVectorStore = _vector_store_stub("InfiniFlow", "ragflow", "InfiniFlow RAGFlow")
TigrisVectorStore = _vector_store_stub("Tigris", "tigrisdb", "Tigris serverless database")
WeaviateCloudVectorStore = _vector_store_stub("WeaviateCloud", "weaviate-client", "Weaviate Cloud Services (WCS)")
PineconeServerlessVectorStore = _vector_store_stub("PineconeServerless", "pinecone", "Pinecone Serverless")
MilvusLiteVectorStore = _vector_store_stub("MilvusLite", "pymilvus", "Milvus Lite (embedded)")
ChromaPersistentVectorStore = _vector_store_stub("ChromaPersistent", "chromadb", "ChromaDB with persistent storage")
QdrantCloudVectorStore = _vector_store_stub("QdrantCloud", "qdrant-client", "Qdrant Cloud managed")
